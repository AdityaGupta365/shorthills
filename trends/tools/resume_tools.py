...
def generate_markdown_report(
    ...
    score_emoji = "🔴" if match_score < 40 else "🟡" if match_score < 70 else "🟢"
...
The following keywords appear in the job description but are **not** in your resume. Consider adding them where relevant:
